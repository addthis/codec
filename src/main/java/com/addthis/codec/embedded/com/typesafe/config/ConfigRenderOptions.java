 ...
 * {@link ConfigValue#render(com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions)}.
 *
 * <p>
...
public final class ConfigRenderOptions {
     ...
     * formatted). See {@link com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions#concise} for stripped-down
     * options. This rendering will not be valid JSON since it has comments.
     *
     * @return the default render options
     */
    public static com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions defaults() {
        return new com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions(true, true, true, true);
    }
     ...
     */
    public static com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions concise() {
        return new com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions(false, false, false, true);
    }
     ...
     * which are controlled by {@link com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions#setOriginComments}.
     *
     * @param value
     *            true to include comments in the render
     * @return options with requested setting for comments
     */
    public com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions setComments(boolean value) {
        if (value == comments)
            return this;
        else
            return new com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions(originComments, value, formatted, json);
    }
     ...
     * {@link com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions#setComments}.
     *
     * @param value
     ...
     */
    public com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions setOriginComments(boolean value) {
        if (value == originComments)
            return this;
        else
            return new com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions(value, comments, formatted, json);
    }
     ...
     */
    public com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions setFormatted(boolean value) {
        if (value == formatted)
            return this;
        else
            return new com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions(originComments, comments, value, json);
    }
     ...
     */
    public com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions setJson(boolean value) {
        if (value == json)
            return this;
        else
            return new com.addthis.codec.embedded.com.typesafe.config.ConfigRenderOptions(originComments, comments, formatted, value);
    }
