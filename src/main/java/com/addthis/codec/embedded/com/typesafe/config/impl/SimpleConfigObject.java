...
final class SimpleConfigObject extends AbstractConfigObject implements Serializable {
    ...
    @Override SimpleConfigObject withoutPath(Path path) {
        ...
        if (v != null && next != null && v instanceof AbstractConfigObject) {
            ...
            Map<String, AbstractConfigValue> smaller = new HashMap<String, AbstractConfigValue>(
                    value.size() - 1);
            for (Entry<String, AbstractConfigValue> old : value.entrySet()) {
    ...
    public Map<String, Object> unwrapped() {
        ...
        for (Entry<String, AbstractConfigValue> e : value.entrySet()) {
    ...
    public Set<Entry<String, ConfigValue>> entrySet() {
        ...
        HashSet<Entry<String, ConfigValue>> entries = new HashSet<Entry<String, ConfigValue>>();
        for (Entry<String, AbstractConfigValue> e : value.entrySet()) {
